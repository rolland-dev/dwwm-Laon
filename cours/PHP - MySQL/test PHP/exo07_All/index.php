             ...
             <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="d-none d-md-block col-md-2" scope="col">Date</th>
                    ...
                    <tr>
                        ...
                        <td class="col-4 col-md-2 text-center">
                            <form method="post" action="index.php">
                                <button class="btn btn-info" title="Editer les infos du livre" type="submit"
                                    value="<?= $value['id'] ?>" name="id_update">E</button>&nbsp;
                                <button class="btn btn-danger" title="Supprimer le livre" type="submit"
                                    value="<?= $value['id'] ?>" name="id_delete">D</button>&nbsp;
                                <button class="btn btn-secondary" title="Archiver le livre" type="submit"
                                    value="<?= $value['id'] ?>" name="id_archive">A</button>
                            </form>
